function [b_slope, Data_ave, All_stast, Reg_Significance, NO_st_d]=func_LinReg1_Trend_station(Data, min_NO_st_d)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
stations_n=size(Data,1); % Total number of the stations
yrs_n=size(Data,2); % Number of the Years that data is available for
